...
namespace Coherence.Generated
{
    ...
    public class Binding_725186fcf50907a46af7116db4455ec7_b36c0966b4f04de38519005aed58eb0c : PositionBinding
    {   
    ...
    [UnityEngine.Scripting.Preserve]
    public class Binding_725186fcf50907a46af7116db4455ec7_e4a7437c78714477b0d824b48e04dfdc : RotationBinding
    {   
        private global::UnityEngine.Transform CastedUnityComponent;
    ...
    [UnityEngine.Scripting.Preserve]
    public class CoherenceSync_725186fcf50907a46af7116db4455ec7 : CoherenceSyncBaked
    {
        private Entity entityId;
        private Logger logger = Coherence.Log.Log.GetLogger<CoherenceSync_725186fcf50907a46af7116db4455ec7>();
        ...
        {
            ["b36c0966b4f04de38519005aed58eb0c"] = new Binding_725186fcf50907a46af7116db4455ec7_b36c0966b4f04de38519005aed58eb0c(),
            ["e4a7437c78714477b0d824b48e04dfdc"] = new Binding_725186fcf50907a46af7116db4455ec7_e4a7437c78714477b0d824b48e04dfdc(),
        };
        
        private Dictionary<string, Action<CommandBinding, CommandsHandler>> bakedCommandBindings = new Dictionary<string, Action<CommandBinding, CommandsHandler>>();
        
        public CoherenceSync_725186fcf50907a46af7116db4455ec7()
        {
        }
        ...
        public override void ReceiveCommand(IEntityCommand command)
        {
            ...
            {
                default:
                    logger.Warning($"CoherenceSync_725186fcf50907a46af7116db4455ec7 Unhandled command: {command.GetType()}.");
                    break;
            }
        }
        ...
        {
            this.logger = logger.With<CoherenceSync_725186fcf50907a46af7116db4455ec7>();
            this.bridge = bridge;
