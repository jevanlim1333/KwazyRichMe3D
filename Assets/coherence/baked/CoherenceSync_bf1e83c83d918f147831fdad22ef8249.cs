...
namespace Coherence.Generated
{
    ...
    public class Binding_bf1e83c83d918f147831fdad22ef8249_b36c0966b4f04de38519005aed58eb0c : PositionBinding
    {   
    ...
    [UnityEngine.Scripting.Preserve]
    public class Binding_bf1e83c83d918f147831fdad22ef8249_e4a7437c78714477b0d824b48e04dfdc : RotationBinding
    {   
        private global::UnityEngine.Transform CastedUnityComponent;
    ...
    [UnityEngine.Scripting.Preserve]
    public class CoherenceSync_bf1e83c83d918f147831fdad22ef8249 : CoherenceSyncBaked
    {
        private Entity entityId;
        private Logger logger = Coherence.Log.Log.GetLogger<CoherenceSync_bf1e83c83d918f147831fdad22ef8249>();
        ...
        {
            ["b36c0966b4f04de38519005aed58eb0c"] = new Binding_bf1e83c83d918f147831fdad22ef8249_b36c0966b4f04de38519005aed58eb0c(),
            ["e4a7437c78714477b0d824b48e04dfdc"] = new Binding_bf1e83c83d918f147831fdad22ef8249_e4a7437c78714477b0d824b48e04dfdc(),
        };
        
        private Dictionary<string, Action<CommandBinding, CommandsHandler>> bakedCommandBindings = new Dictionary<string, Action<CommandBinding, CommandsHandler>>();
        
        public CoherenceSync_bf1e83c83d918f147831fdad22ef8249()
        {
        }
        ...
        public override void ReceiveCommand(IEntityCommand command)
        {
            ...
            {
                default:
                    logger.Warning($"CoherenceSync_bf1e83c83d918f147831fdad22ef8249 Unhandled command: {command.GetType()}.");
                    break;
            }
        }
        ...
        {
            this.logger = logger.With<CoherenceSync_bf1e83c83d918f147831fdad22ef8249>();
            this.bridge = bridge;
